...
const GRAMMAR_DATA = {
  ...
  "Second Term": {
    ...
    "passive-voice": {
      ...
      type: "passage",
      blankType: "select",
      instructions: "Select the correct option to complete the passage.",
      // blankType "select": each blank is a dropdown with 4 options (1 correct + 3 distractors).
      // A blank object: { prompt: "(verb)", answer: "...", distractors: [...], explanation: "..." }
      ...
      exercises: [
        {
          ...
          segments: [
            ...
            { prompt: "(clean)", answer: "are cleaned", distractors: ["cleaned", "are clean", "clean"], explanation: "Present simple passive: a routine action done to the classrooms every morning." },
            " every morning by the cleaning staff, but on that day, students ",
            { prompt: "(decorate)", answer: "decorated", distractors: ["was decorated", "decorate", "is decorate"], explanation: "Active voice (past simple): the students did the action themselves." },
            " them by themselves. A lot of posters ",
            { prompt: "(make)", answer: "were made", distractors: ["made", "were make", "make"], explanation: "Past simple passive: a plural subject (posters) receives the action in the past." },
            " by the art club before the event started. Our teacher told us that plastic bottles should ",
            { prompt: "(not use)", answer: "not be used", distractors: ["not used", "not be use", "not use"], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' goes after the modal." },
            " at school. Also, more trees ",
            { prompt: "(plant)", answer: "will be planted", distractors: ["planted", "will be plant", "will plant"], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " in the future if we want a cleaner environment.\n\nDuring the event, some students picked up rubbish while others ",
            { prompt: "(plant)", answer: "planted", distractors: ["were planted", "plant", "is plant"], explanation: "Active voice (past simple): the students performed the action of planting." },
            " flowers in the garden. Snacks ",
            { prompt: "(provide)", answer: "were provided", distractors: ["provided", "were provide", "provide"], explanation: "Past simple passive: a plural subject (snacks) receives the action in the past." },
            " by the canteen because the event lasted all day, but soft drinks ",
            { prompt: "(not allow)", answer: "were not allowed", distractors: ["not allowed", "were not allow", "did not allow"], explanation: "Past simple passive (negative): a plural subject with 'were not' + past participle." },
            " because the school wanted everyone to be healthy. At noon, a short speech ",
            { prompt: "(give)", answer: "was given", distractors: ["given", "was give", "gave"], explanation: "Past simple passive: a singular subject (speech) receives the action in the past." },
            " by the principal, and all students ",
            { prompt: "(listen)", answer: "listened", distractors: ["was listened", "listen", "is listen"], explanation: "Active voice (past simple): the students did the listening themselves." },
            " carefully.\n\nAfter the event, the playground was very clean. The rubbish ",
            { prompt: "(put)", answer: "was put", distractors: ["being put", "were put", "put"], explanation: "Past simple passive: a singular subject (rubbish) receives the action; 'put' is unchanged as a past participle." },
            " into large bags, and the bags ",
            { prompt: "(send)", answer: "were sent", distractors: ["sent", "were send", "send"], explanation: "Past simple passive: a plural subject (bags) receives the action in the past." },
            " to the recycling center later that afternoon. Our class teacher was proud because we ",
            { prompt: "(put)", answer: "put", distractors: ["were put", "puts", "is put"], explanation: "Active voice (past simple): 'we' performed the action; 'put' is unchanged in the past simple." },
            " a lot of effort into the activity. She says that another Green Day ",
            { prompt: "(hold)", answer: "will be held", distractors: ["held", "will be hold", "will hold"], explanation: "Future passive: 'will be' + past participle for a future event." },
            " next year, and even more parents ",
            { prompt: "(invite)", answer: "will be invited", distractors: ["invited", "will be invite", "will invite"], explanation: "Future passive: 'will be' + past participle; the parents receive the action." },
            " to join."
          ]
        },
        {
          ...
          segments: [
            ...
            { prompt: "(upload)", answer: "are uploaded", distractors: ["uploaded", "are upload", "upload"], explanation: "Present simple passive: a routine action; a plural subject (videos) takes 'are' + past participle." },
            " to our class channel. Two weeks ago, Mina suggested a mini-documentary about interesting places in our town. The main idea ",
            { prompt: "(discuss)", answer: "was discussed", distractors: ["discussed", "was discuss", "discuss"], explanation: "Past simple passive: a singular subject (idea) receives the action in the past." },
            " during lunch, and everyone ",
            { prompt: "(give)", answer: "gave", distractors: ["was given", "give", "is give"], explanation: "Active voice (past simple): 'everyone' performed the action of giving." },
            " one suggestion. We agreed that private messages should ",
            { prompt: "(not show)", answer: "not be shown", distractors: ["not shown", "not be show", "not show"], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' follows the modal." },
            " in the video. Also, students\u2019 faces ",
            { prompt: "(blur)", answer: "will be blurred", distractors: ["blurred", "will be blur", "will blur"], explanation: "Future passive: 'will be' + past participle for an action that may happen later." },
            " in the future if they ask for privacy.\n\nOn Saturday morning, our group met near the old library. Some clips ",
            { prompt: "(film)", answer: "were filmed", distractors: ["filmed", "were film", "film"], explanation: "Past simple passive: a plural subject (clips) receives the action in the past." },
            " by the river, while Leo ",
            { prompt: "(record)", answer: "recorded", distractors: ["was recorded", "record", "is record"], explanation: "Active voice (past simple): Leo performed the action of recording." },
            " background sounds on his phone. The drone ",
            { prompt: "(not use)", answer: "was not used", distractors: ["not used", "was not use", "did not use"], explanation: "Past simple passive (negative): a singular subject with 'was not' + past participle." },
            " because the park was too crowded. Later, all the phones ",
            { prompt: "(charge)", answer: "were charged", distractors: ["charged", "were charge", "charge"], explanation: "Past simple passive: a plural subject (phones) receives the action in the past." },
            " at a caf\u00e9, and Sara ",
            { prompt: "(edit)", answer: "edited", distractors: ["was edited", "edit", "is edit"], explanation: "Active voice (past simple): Sara performed the action of editing." },
            " the first part of the video there.\n\nBefore the final version went online, the captions ",
            { prompt: "(add)", answer: "were added", distractors: ["added", "were add", "add"], explanation: "Past simple passive: a plural subject (captions) receives the action in the past." },
            " by Tom, and all the facts ",
            { prompt: "(check)", answer: "were checked", distractors: ["checked", "were check", "check"], explanation: "Past simple passive: a plural subject (facts) receives the action in the past." },
            " carefully. By Monday morning, the video ",
            { prompt: "(watch)", answer: "was watched", distractors: ["watched", "was watch", "watch"], explanation: "Past simple passive: a singular subject (video) receives the action in the past." },
            " by hundreds of students. Our teacher says that another episode ",
            { prompt: "(produce)", answer: "will be produced", distractors: ["produced", "will be produce", "will produce"], explanation: "Future passive: 'will be' + past participle for a future event." },
            " next month, and a behind-the-scenes clip ",
            { prompt: "(share)", answer: "will be shared", distractors: ["shared", "will be share", "will share"], explanation: "Future passive: 'will be' + past participle; the clip receives the action." },
            " on the school website."
          ]
        },
        {
          title: "Green Week Book Stall",
          segments: [
            "Last month, our Form 2 class took part in Green Week at our secondary school in Kowloon. During our first meeting, our class monitor ",
            { prompt: "(collect)", answer: "collected", distractors: ["was collected", "collect", "is collect"], explanation: "Active voice (past simple): the class monitor performed the action of collecting." },
            " ideas from everyone. After a short discussion, a second-hand book stall ",
            { prompt: "(choose)", answer: "was chosen", distractors: ["chosen", "was choose", "chose"], explanation: "Past simple passive: a singular subject (stall) receives the action in the past." },
            " as our class project. Every morning that week, unwanted books ",
            { prompt: "(bring)", answer: "were brought", distractors: ["brought", "were bring", "bring"], explanation: "Past simple passive: a plural subject (books) receives the action in the past." },
            " to the classroom by students from different forms. Our class teacher reminded us that damaged books should ",
            { prompt: "(not sell)", answer: "not be sold", distractors: ["not sold", "not be sell", "not sell"], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' goes after the modal." },
            ", so we checked each book carefully.\n\nOn Wednesday afternoon, three prefects ",
            { prompt: "(help)", answer: "helped", distractors: ["were helped", "help", "is help"], explanation: "Active voice (past simple): the prefects performed the action of helping." },
            " us move the books to the covered playground. The tables ",
            { prompt: "(set up)", answer: "were set up", distractors: ["set up", "were set", "set"], explanation: "Past simple passive: a plural subject (tables) receives the action; phrasal verb 'set up'." },
            " near the tuck shop, and colourful signs ",
            { prompt: "(put)", answer: "were put", distractors: ["put", "was put", "being put"], explanation: "Past simple passive: a plural subject (signs) receives the action; 'put' is unchanged as a past participle." },
            " on the walls. Some Primary 6 visitors from a nearby school came for a campus tour, so free bookmarks ",
            { prompt: "(give)", answer: "were given", distractors: ["given", "were give", "gave"], explanation: "Past simple passive: a plural subject (bookmarks) receives the action in the past." },
            " to them. However, the loudspeaker ",
            { prompt: "(not use)", answer: "was not used", distractors: ["not used", "was not use", "did not use"], explanation: "Past simple passive (negative): a singular subject with 'was not' + past participle." },
            " because an oral exam was taking place in the next block.\n\nBy lunchtime, many storybooks and comics ",
            { prompt: "(buy)", answer: "were bought", distractors: ["bought", "were buy", "buy"], explanation: "Past simple passive: a plural subject (storybooks and comics) receives the action in the past." },
            " by junior students. Our group ",
            { prompt: "(raise)", answer: "raised", distractors: ["was raised", "raise", "is raise"], explanation: "Active voice (past simple): the group performed the action of raising the money." },
            " over eight hundred dollars before the bell rang. The remaining books ",
            { prompt: "(pack)", answer: "were packed", distractors: ["packed", "were pack", "pack"], explanation: "Past simple passive: a plural subject (books) receives the action in the past." },
            " into boxes after school, and the money ",
            { prompt: "(count)", answer: "was counted", distractors: ["counted", "was count", "count"], explanation: "Past simple passive: a singular subject (money) receives the action in the past." },
            " twice by the class treasurer. This coming Friday, the donation ",
            { prompt: "(send)", answer: "will be sent", distractors: ["sent", "will be send", "will send"], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " to a local children\u2019s charity. Our teacher says that a thank-you notice ",
            { prompt: "(post)", answer: "will be posted", distractors: ["posted", "will be post", "will post"], explanation: "Future passive: 'will be' + past participle for a future event." },
            " on the school noticeboard after the charity receives the money."
          ]
        },
        {
          title: "Sports Day Cheering Corner",
          segments: [
            "At our school, Sports Day ",
            { prompt: "(hold)", answer: "is held", distractors: ["held", "is hold", "holds"], explanation: "Present simple passive: a routine/annual event; a singular subject takes 'is' + past participle." },
            " every year at the public sports ground in Wan Chai. This year, our Secondary 3 class decided to design a cheering area for our House. First, the House captain ",
            { prompt: "(explain)", answer: "explained", distractors: ["was explained", "explain", "is explain"], explanation: "Active voice (past simple): the House captain performed the action of explaining." },
            " the plan during assembly. Then several designs ",
            { prompt: "(draw)", answer: "were drawn", distractors: ["drawn", "were draw", "drew"], explanation: "Past simple passive: a plural subject (designs) receives the action in the past." },
            " by our classmates after school. Our teacher told us that rude slogans must ",
            { prompt: "(not write)", answer: "not be written", distractors: ["not written", "not be write", "not write"], explanation: "Passive with a modal (must): use 'be' + past participle; 'not' goes after the modal." },
            " on any banners.\n\nOn the day before Sports Day, the final banner ",
            { prompt: "(paint)", answer: "was painted", distractors: ["painted", "was paint", "paint"], explanation: "Past simple passive: a singular subject (banner) receives the action in the past." },
            " in the art room. Jason and Mei Ling ",
            { prompt: "(carry)", answer: "carried", distractors: ["were carried", "carry", "is carry"], explanation: "Active voice (past simple): Jason and Mei Ling performed the action of carrying." },
            " boxes of water bottles to the school hall, while the name stickers ",
            { prompt: "(prepare)", answer: "were prepared", distractors: ["prepared", "were prepare", "prepare"], explanation: "Past simple passive: a plural subject (stickers) receives the action in the past." },
            " by two prefects. The medals ",
            { prompt: "(not display)", answer: "were not displayed", distractors: ["not displayed", "were not display", "did not display"], explanation: "Past simple passive (negative): a plural subject with 'were not' + past participle." },
            " on that day because the teachers wanted to keep them safe. Later, a short notice ",
            { prompt: "(send)", answer: "was sent", distractors: ["sent", "was send", "send"], explanation: "Past simple passive: a singular subject (notice) receives the action in the past." },
            " to all students through the school app.\n\nWhen we arrived at the sports ground the next morning, the seats for each House ",
            { prompt: "(mark)", answer: "were marked", distractors: ["marked", "were mark", "mark"], explanation: "Past simple passive: a plural subject (seats) receives the action in the past." },
            " clearly. Our class ",
            { prompt: "(cheer)", answer: "cheered", distractors: ["was cheered", "cheer", "is cheer"], explanation: "Active voice (past simple): our class performed the action of cheering." },
            " loudly during the relay races, and many photos ",
            { prompt: "(take)", answer: "were taken", distractors: ["taken", "were take", "took"], explanation: "Past simple passive: a plural subject (photos) receives the action in the past." },
            " by the school photographer. After the prize presentation, the used paper cups ",
            { prompt: "(collect)", answer: "were collected", distractors: ["collected", "were collect", "collect"], explanation: "Past simple passive: a plural subject (cups) receives the action in the past." },
            " for recycling. This coming week, the best photos ",
            { prompt: "(show)", answer: "will be shown", distractors: ["shown", "will be show", "will show"], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " on the school website, and a report about Sports Day ",
            { prompt: "(write)", answer: "will be written", distractors: ["written", "will be write", "will write"], explanation: "Future passive: 'will be' + past participle; the report receives the action." },
            " by the English Club."
          ]
        },
        {
          title: "English Week Board Game Corner",
          segments: [
            "English Week ",
            { prompt: "(organise)", answer: "is organised", distractors: ["organised", "is organise", "organises"], explanation: "Present simple passive: a routine/annual event; a singular subject takes 'is' + past participle." },
            " every March at our secondary school in Sha Tin. This year, our Form 1 class wanted to run a board-game corner outside the library. During the planning meeting, Miss Chan ",
            { prompt: "(show)", answer: "showed", distractors: ["was shown", "show", "is show"], explanation: "Active voice (past simple): Miss Chan performed the action of showing." },
            " us several word games, and the rules ",
            { prompt: "(explain)", answer: "were explained", distractors: ["explained", "were explain", "explain"], explanation: "Past simple passive: a plural subject (rules) receives the action in the past." },
            " clearly on the screen. We decided that mobile phones should ",
            { prompt: "(not allow)", answer: "not be allowed", distractors: ["not allowed", "not be allow", "not allow"], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' goes after the modal." },
            " during the games because players needed to talk to one another in English.\n\nAfter school on Tuesday, our group ",
            { prompt: "(make)", answer: "made", distractors: ["was made", "make", "is make"], explanation: "Active voice (past simple): the group performed the action of making." },
            " small prize cards in the classroom. The game tables ",
            { prompt: "(move)", answer: "were moved", distractors: ["moved", "were move", "move"], explanation: "Past simple passive: a plural subject (tables) receives the action in the past." },
            " to the corridor by two janitors, and colourful instruction sheets ",
            { prompt: "(put up)", answer: "were put up", distractors: ["put up", "were put", "put"], explanation: "Past simple passive: a plural subject (sheets) receives the action; phrasal verb 'put up' with 'put' unchanged as a past participle." },
            " on the noticeboards. A few difficult words ",
            { prompt: "(not include)", answer: "were not included", distractors: ["not included", "were not include", "did not include"], explanation: "Past simple passive (negative): a plural subject with 'were not' + past participle." },
            " in the first round because some junior-form students might not know them. Before we left, the prize stickers ",
            { prompt: "(put)", answer: "were put", distractors: ["put", "was put", "being put"], explanation: "Past simple passive: a plural subject (stickers) receives the action; 'put' is unchanged as a past participle." },
            " into separate envelopes.\n\nAt lunchtime the next day, many students ",
            { prompt: "(join)", answer: "joined", distractors: ["were joined", "join", "is join"], explanation: "Active voice (past simple): the students performed the action of joining." },
            " the games happily. Each winning team ",
            { prompt: "(give)", answer: "was given", distractors: ["given", "was give", "gave"], explanation: "Past simple passive: a singular subject (team) receives the action in the past." },
            " a stamp on its score card. The best players\u2019 names ",
            { prompt: "(write)", answer: "were written", distractors: ["written", "were write", "wrote"], explanation: "Past simple passive: a plural subject (names) receives the action in the past." },
            " on the English Corner board after the final round. During the week, over two hundred students ",
            { prompt: "(visit)", answer: "visited", distractors: ["were visited", "visit", "is visit"], explanation: "Active voice (past simple): the students performed the action of visiting." },
            " the board-game corner. This coming term, a bigger English activity ",
            { prompt: "(plan)", answer: "will be planned", distractors: ["planned", "will be plan", "will plan"], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " by the English Club, and more student helpers ",
            { prompt: "(invite)", answer: "will be invited", distractors: ["invited", "will be invite", "will invite"], explanation: "Future passive: 'will be' + past participle; the helpers receive the action." },
            " to take part."
          ]
        }
      ]
      ...
      exercises: [
        ...
        {
          title: "A Class Picnic to Sai Kung",
          segments: [
            "Last Friday, our Form 2 class went on ",
            { answer: "a" },
            " school picnic to Sai Kung Country Park. A school bus was waiting for us at the main gate, and we took ",
            { answer: "the" },
            " bus from there. Before we left, our class teacher reminded us to bring ",
            { answer: "X" },
            " water, snacks, and our Octopus cards. Ken forgot to bring ",
            { answer: "an" },
            " umbrella, but luckily the weather stayed fine.\n\nThree teachers came with us. When we arrived, ",
            { answer: "the" },
            " teachers counted the students carefully. Then we walked along ",
            { answer: "a" },
            " short path near the sea. It was ",
            { answer: "an" },
            " easy walk, so everyone could learn about ",
            { answer: "X" },
            " nature and take photos. At about noon, we had ",
            { answer: "X" },
            " lunch under some trees. Some students played ",
            { answer: "X" },
            " badminton, while others sat on ",
            { answer: "the" },
            " grass in the picnic area and chatted.\n\nAfter lunch, we joined ",
            { answer: "an" },
            " interesting nature quiz. Our group found ",
            { answer: "the" },
            " answer to the last question at the top of a signboard. Before going home, Miss Chan gave each student ",
            { answer: "a" },
            " small stamp on the picnic worksheet. We returned to school by ",
            { answer: "X" },
            " bus and arrived before four. It was ",
            { answer: "a" },
            " wonderful day for our class."
          ]
        },
        {
          title: "A History Club Museum Visit",
          segments: [
            "On Tuesday, our History Club visited ",
            { answer: "the" },
            " Hong Kong Museum of History after school. We first gathered outside ",
            { answer: "the" },
            " General Office because Ms Wong had to check our names. She gave each group ",
            { answer: "a" },
            " useful guidebook and told us not to run in the station. Then we walked to Prince Edward Station and travelled by ",
            { answer: "X" },
            " MTR.\n\nDuring the journey, I stood near ",
            { answer: "the" },
            " train door closest to me and held the handrail. My friend Jason was reading ",
            { answer: "an" },
            " article about old Hong Kong shops on his phone. When we changed trains at Tsim Sha Tsui, ",
            { answer: "the" },
            " platform was crowded, but everyone stayed calm. We arrived at the museum at four o\u2019clock and entered ",
            { answer: "the" },
            " main exhibition hall on the first floor.\n\nInside, we saw ",
            { answer: "an" },
            " old tram, some fishing tools, and models of public housing estates. I took notes about ",
            { answer: "X" },
            " daily life in the past because I needed ideas for my project. A museum guide welcomed us at the entrance. Later, ",
            { answer: "the" },
            " guide explained how families celebrated festivals in small flats. It was ",
            { answer: "an" },
            " interesting talk, and even the quiet students asked questions.\n\nBefore we left, we bought ",
            { answer: "X" },
            " postcards from the gift shop. Ms Wong reminded us to go ",
            { answer: "X" },
            " home before dinner and not to stay out too late at ",
            { answer: "X" },
            " night. I felt tired, but it was ",
            { answer: "a" },
            " meaningful visit."
          ]
        },
        {
          title: "The Schools Speech Festival",
          segments: [
            "Every November, many students in our school take part in ",
            { answer: "the" },
            " Hong Kong Schools Speech Festival. This year, I decided to take part in one event, ",
            { answer: "an" },
            " English Solo Verse Speaking event, for the first time. My English teacher gave me ",
            { answer: "a" },
            " poem and asked me to practise after school twice a week. At first, I was nervous because ",
            { answer: "the" },
            " poem was quite long.\n\nOn the day of the competition, my mother and I travelled to Wan Chai by ",
            { answer: "X" },
            " MTR. We arrived early and waited outside ",
            { answer: "a" },
            " classroom that was being used for the competition with other contestants. Some students were reading quietly, while others drank ",
            { answer: "X" },
            " water and stretched their arms. I looked at ",
            { answer: "the" },
            " clock above the door and tried to breathe slowly.\n\nWhen my number was called, I walked into ",
            { answer: "the" },
            " same room and greeted the adjudicator. She gave me ",
            { answer: "a" },
            " friendly smile, so I felt calmer. I remembered to speak clearly and use ",
            { answer: "X" },
            " eye contact. After all the students had performed, ",
            { answer: "the" },
            " adjudicator announced the results.\n\nI did not win ",
            { answer: "a" },
            " prize, but I received ",
            { answer: "a" },
            " certificate and useful comments. My teacher said that ",
            { answer: "X" },
            " regular practice would help me improve. I went back to school with ",
            { answer: "a" },
            " happier heart."
          ]
        }
