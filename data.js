      ...
      exercises: [
        ...
        },
        {
          ...
          segments: [
            ...
            { prompt: "(collect)", answer: "collected", alternatives: [], explanation: "Active voice (past simple): the class monitor performed the action of collecting." },
            " ideas from everyone. After a short discussion, a second-hand book stall ",
            { prompt: "(choose)", answer: "was chosen", alternatives: [], explanation: "Past simple passive: a singular subject (stall) receives the action in the past." },
            " as our class project. Every morning that week, unwanted books ",
            { prompt: "(bring)", answer: "were brought", alternatives: [], explanation: "Past simple passive: a plural subject (books) receives the action in the past." },
            " to the classroom by students from different forms. Our class teacher reminded us that damaged books should ",
            { prompt: "(not sell)", answer: "not be sold", alternatives: [], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' goes after the modal." },
            ", so we checked each book carefully.\n\nOn Wednesday afternoon, three prefects ",
            { prompt: "(help)", answer: "helped", alternatives: [], explanation: "Active voice (past simple): the prefects performed the action of helping." },
            " us move the books to the covered playground. The tables ",
            { prompt: "(set up)", answer: "were set up", alternatives: [], explanation: "Past simple passive: a plural subject (tables) receives the action; phrasal verb 'set up'." },
            " near the tuck shop, and colourful signs ",
            { prompt: "(put)", answer: "were put", alternatives: [], explanation: "Past simple passive: a plural subject (signs) receives the action; 'put' is unchanged as a past participle." },
            " on the walls. Some Primary 6 visitors from a nearby school came for a campus tour, so free bookmarks ",
            { prompt: "(give)", answer: "were given", alternatives: [], explanation: "Past simple passive: a plural subject (bookmarks) receives the action in the past." },
            ...
            { prompt: "(buy)", answer: "were bought", alternatives: [], explanation: "Past simple passive: a plural subject (storybooks and comics) receives the action in the past." },
            " by junior students. Our group ",
            { prompt: "(raise)", answer: "raised", alternatives: [], explanation: "Active voice (past simple): the group performed the action of raising the money." },
            " over eight hundred dollars before the bell rang. The remaining books ",
            { prompt: "(pack)", answer: "were packed", alternatives: [], explanation: "Past simple passive: a plural subject (books) receives the action in the past." },
            " into boxes after school, and the money ",
            { prompt: "(count)", answer: "was counted", alternatives: [], explanation: "Past simple passive: a singular subject (money) receives the action in the past." },
            " twice by the class treasurer. This coming Friday, the donation ",
            { prompt: "(send)", answer: "will be sent", alternatives: [], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " to a local children\u2019s charity. Our teacher says that a thank-you notice ",
            { prompt: "(post)", answer: "will be posted", alternatives: [], explanation: "Future passive: 'will be' + past participle for a future event." },
        ...
        },
        {
          ...
          segments: [
            ...
            { prompt: "(hold)", answer: "is held", alternatives: [], explanation: "Present simple passive: a routine/annual event; a singular subject takes 'is' + past participle." },
            ...
            { prompt: "(explain)", answer: "explained", alternatives: [], explanation: "Active voice (past simple): the House captain performed the action of explaining." },
            " the plan during assembly. Then several designs ",
            { prompt: "(draw)", answer: "were drawn", alternatives: [], explanation: "Past simple passive: a plural subject (designs) receives the action in the past." },
            " by our classmates after school. Our teacher told us that rude slogans must ",
            { prompt: "(not write)", answer: "not be written", alternatives: [], explanation: "Passive with a modal (must): use 'be' + past participle; 'not' goes after the modal." },
            " on any banners.\n\nOn the day before Sports Day, the final banner ",
            { prompt: "(paint)", answer: "was painted", alternatives: [], explanation: "Past simple passive: a singular subject (banner) receives the action in the past." },
            " in the art room. Jason and Mei Ling ",
            { prompt: "(carry)", answer: "carried", alternatives: [], explanation: "Active voice (past simple): Jason and Mei Ling performed the action of carrying." },
            " boxes of water bottles to the school hall, while the name stickers ",
            { prompt: "(prepare)", answer: "were prepared", alternatives: [], explanation: "Past simple passive: a plural subject (stickers) receives the action in the past." },
            " by two prefects. The medals ",
            { prompt: "(not display)", answer: "were not displayed", alternatives: [], explanation: "Past simple passive (negative): a plural subject with 'were not' + past participle." },
            " on that day because the teachers wanted to keep them safe. Later, a short notice ",
            { prompt: "(send)", answer: "was sent", alternatives: [], explanation: "Past simple passive: a singular subject (notice) receives the action in the past." },
            " to all students through the school app.\n\nWhen we arrived at the sports ground the next morning, the seats for each House ",
            { prompt: "(mark)", answer: "were marked", alternatives: [], explanation: "Past simple passive: a plural subject (seats) receives the action in the past." },
            " clearly. Our class ",
            { prompt: "(cheer)", answer: "cheered", alternatives: [], explanation: "Active voice (past simple): our class performed the action of cheering." },
            " loudly during the relay races, and many photos ",
            { prompt: "(take)", answer: "were taken", alternatives: [], explanation: "Past simple passive: a plural subject (photos) receives the action in the past." },
            " by the school photographer. After the prize presentation, the used paper cups ",
            { prompt: "(collect)", answer: "were collected", alternatives: [], explanation: "Past simple passive: a plural subject (cups) receives the action in the past." },
            " for recycling. This coming week, the best photos ",
            { prompt: "(show)", answer: "will be shown", alternatives: [], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " on the school website, and a report about Sports Day ",
            { prompt: "(write)", answer: "will be written", alternatives: [], explanation: "Future passive: 'will be' + past participle; the report receives the action." },
            " by the English Club."
          ]
        },
        {
          ...
          segments: [
            "English Week ",
            { prompt: "(organise)", answer: "is organised", alternatives: [], explanation: "Present simple passive: a routine/annual event; a singular subject takes 'is' + past participle." },
            ...
            { prompt: "(show)", answer: "showed", alternatives: [], explanation: "Active voice (past simple): Miss Chan performed the action of showing." },
            " us several word games, and the rules ",
            { prompt: "(explain)", answer: "were explained", alternatives: [], explanation: "Past simple passive: a plural subject (rules) receives the action in the past." },
            " clearly on the screen. We decided that mobile phones should ",
            { prompt: "(not allow)", answer: "not be allowed", alternatives: [], explanation: "Passive with a modal (should): use 'be' + past participle; 'not' goes after the modal." },
            " during the games because players needed to talk to one another in English.\n\nAfter school on Tuesday, our group ",
            { prompt: "(make)", answer: "made", alternatives: [], explanation: "Active voice (past simple): the group performed the action of making." },
            " small prize cards in the classroom. The game tables ",
            { prompt: "(move)", answer: "were moved", alternatives: [], explanation: "Past simple passive: a plural subject (tables) receives the action in the past." },
            " to the corridor by two janitors, and colourful instruction sheets ",
            { prompt: "(put up)", answer: "were put up", alternatives: [], explanation: "Past simple passive: a plural subject (sheets) receives the action; phrasal verb 'put up' with 'put' unchanged as a past participle." },
            " on the noticeboards. A few difficult words ",
            { prompt: "(not include)", answer: "were not included", alternatives: [], explanation: "Past simple passive (negative): a plural subject with 'were not' + past participle." },
            " in the first round because some junior-form students might not know them. Before we left, the prize stickers ",
            { prompt: "(put)", answer: "were put", alternatives: [], explanation: "Past simple passive: a plural subject (stickers) receives the action; 'put' is unchanged as a past participle." },
            " into separate envelopes.\n\nAt lunchtime the next day, many students ",
            { prompt: "(join)", answer: "joined", alternatives: [], explanation: "Active voice (past simple): the students performed the action of joining." },
            " the games happily. Each winning team ",
            { prompt: "(give)", answer: "was given", alternatives: [], explanation: "Past simple passive: a singular subject (team) receives the action in the past." },
            " a stamp on its score card. The best players\u2019 names ",
            { prompt: "(write)", answer: "were written", alternatives: [], explanation: "Past simple passive: a plural subject (names) receives the action in the past." },
            " on the English Corner board after the final round. During the week, over two hundred students ",
            { prompt: "(visit)", answer: "visited", alternatives: [], explanation: "Active voice (past simple): the students performed the action of visiting." },
            " the board-game corner. This coming term, a bigger English activity ",
            { prompt: "(plan)", answer: "will be planned", alternatives: [], explanation: "Future passive: 'will be' + past participle for an action that will happen." },
            " by the English Club, and more student helpers ",
            { prompt: "(invite)", answer: "will be invited", alternatives: [], explanation: "Future passive: 'will be' + past participle; the helpers receive the action." },
            " to take part."
          ]
        }
      ]
