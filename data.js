  ...
  "Second Term": {
    ...
    "reported-speech": {
      ...
      questions: [
        ...
        {"prompt": "Karen told me, ‘I can meet you here today.’", "frameCorrect": "Karen told me", "frameWrong": ["Karen said me", "Karen told"], "clauseCorrect": ["she", "could meet", "me", "there"], "clauseWrong": ["I", "can meet", "here", "you"], "timeCorrect": ["that day"], "timeWrong": ["today", "yesterday"], "type": "statement", "combined": "Karen told me that she could meet me there that day."},
        {"prompt": "Paul said to his sister, ‘I saw your teacher at the supermarket yesterday.’", "frameCorrect": "Paul said to his sister", "frameWrong": ["Paul said", "Paul said his sister"], "clauseCorrect": ["he", ["saw", "had seen"], "her", "teacher at the supermarket"], "clauseWrong": ["I", "see", "your"], "timeCorrect": ["the day before", "the previous day"], "timeWrong": ["yesterday", "tomorrow"], "type": "statement", "combined": "Paul said to his sister that he [saw / had seen] her teacher at the supermarket the [day before / previous day]."},
        {"prompt": "‘Please buy me a newspaper on your way home,’ my father asked me.", "frameCorrect": "My father asked me", "frameWrong": ["My father asked", "My father said me"], "clauseCorrect": ["to buy", "him", "a newspaper on", "my", "way home"], "clauseWrong": ["buy", "me", "your"], "timeCorrect": [], "timeWrong": [], "type": "command", "combined": "My father asked me to buy him a newspaper on my way home."},
        ...
        {"prompt": "‘These books are expensive to me,’ said Tom.", "frameCorrect": "Tom said", "frameWrong": ["Tom said me", "Tom told"], "clauseCorrect": ["those", "books", ["were", "had been"], "expensive to", "him"], "clauseWrong": ["these", "are", "me"], "timeCorrect": [], "timeWrong": [], "type": "statement", "combined": "Tom said that those books [were / had been] expensive to him."},
        {"prompt": "‘I’m not going to buy this dress,’ said Lily.", "frameCorrect": "Lily said", "frameWrong": ["Lily said me", "Lily told"], "clauseCorrect": ["she", ["was not going", "had not been going"], "to buy", "that", "dress"], "clauseWrong": ["I", "am not going", "this"], "timeCorrect": [], "timeWrong": [], "type": "statement", "combined": "Lily said that she [was not going / had not been going] to buy that dress."},
        {"prompt": "Mike said, ‘I handed in my homework two days ago.’", "frameCorrect": "Mike said", "frameWrong": ["Mike said me", "Mike told"], "clauseCorrect": ["he", ["handed", "had handed"], "in", "his", "homework"], "clauseWrong": ["I", "hand", "my"], "timeCorrect": ["two days before", "two days previously"], "timeWrong": ["two days ago", "in two days"], "type": "statement", "combined": "Mike said that he [handed / had handed] in his homework two days before."},
        ...
        {"prompt": "The coach warned the players, ‘Do not leave your water bottles here after practice.’", "frameCorrect": "The coach warned the players", "frameWrong": ["The coach warned", "The coach said the players"], "clauseCorrect": ["not to leave", "their", "water bottles", "there", "after practice"], "clauseWrong": ["do not leave", "here", "your"], "timeCorrect": [], "timeWrong": [], "type": "command", "combined": "The coach warned the players not to leave their water bottles there after practice."},
        ...
        {"prompt": "Noah said to Lily, ‘I found your notebook in the library yesterday.’", "frameCorrect": "Noah said to Lily", "frameWrong": ["Noah said", "Noah said Lily"], "clauseCorrect": ["he", ["found", "had found"], "her", "notebook in the library"], "clauseWrong": ["I", "find", "your"], "timeCorrect": ["the day before", "the previous day"], "timeWrong": ["yesterday", "tomorrow"], "type": "statement", "combined": "Noah said to Lily that he [found / had found] her notebook in the library the [day before / previous day]."},
        ...
        {"prompt": "Ben said, ‘I have already chosen my character.’", "frameCorrect": "Ben said", "frameWrong": ["Ben said me", "Ben told"], "clauseCorrect": ["he", "had already chosen", "his", "character"], "clauseWrong": ["I", "have already chosen", "my"], "timeCorrect": [], "timeWrong": [], "type": "statement", "combined": "Ben said that he had already chosen his character."},
        {"prompt": "Chloe said to Ryan, ‘I watched your practice match yesterday.’", "frameCorrect": "Chloe said to Ryan", "frameWrong": ["Chloe said", "Chloe said Ryan"], "clauseCorrect": ["she", ["watched", "had watched"], "his", "practice match"], "clauseWrong": ["I", "watch", "your"], "timeCorrect": ["the day before", "the previous day"], "timeWrong": ["yesterday", "tomorrow"], "type": "statement", "combined": "Chloe said to Ryan that she [watched / had watched] his practice match the [day before / previous day]."},
        ...
        {"prompt": "Ethan said to Grace, ‘I saw your plant display in the hall yesterday.’", "frameCorrect": "Ethan said to Grace", "frameWrong": ["Ethan said", "Ethan said Grace"], "clauseCorrect": ["he", ["saw", "had seen"], "her", "plant display in the hall"], "clauseWrong": ["I", "see", "your"], "timeCorrect": ["the day before", "the previous day"], "timeWrong": ["yesterday", "tomorrow"], "type": "statement", "combined": "Ethan said to Grace that he [saw / had seen] her plant display in the hall the [day before / previous day]."},
        ...
        {"prompt": "Noah said, ‘These leaflets are useful to us.’", "frameCorrect": "Noah said", "frameWrong": ["Noah said me", "Noah told"], "clauseCorrect": ["those", "leaflets", ["were", "had been"], "useful to", "them"], "clauseWrong": ["these", "are", "us"], "timeCorrect": [], "timeWrong": [], "type": "statement", "combined": "Noah said that those leaflets [were / had been] useful to them."},
